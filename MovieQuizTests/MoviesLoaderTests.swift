...
class MoviesLoaderTests: XCTestCase {
    func testSuccessLoading() throws {
        // Given
           let stubNetworkClient = StubNetwortClienr(emulateError: false) // говорим, что не хотим эмулировать ошибку
    ...
    func testFailureLoading() throws {
        // Given
           let stubNetworkClient = StubNetwortClienr(emulateError: true) // говорим, что хотим эмулировать ошибку
           let loader = MoviesLoader(networkClient: stubNetworkClient)
...
struct StubNetwortClienr: NetworkRouting{
